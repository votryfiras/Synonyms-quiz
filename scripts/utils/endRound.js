import { stopStopwatch, currentFormattedTimeValue } from "./stopwatch.js";
...
export default function endRound(rounds) {
  ...
  nextButtonElem.removeAttribute('data-skip');
  currentRound.completionTime = convertToSeconds(currentFormattedTimeValue);
